...
author:
  - Gustavo Arballo
thumbnail:
  - src: /img/tapa-iyp.png
highlight: false
highlight2: false
exclude_thumbnail_from_body: false
---
Hace pocos días se publicò este ensayo de Roberto Gargarella (Infobae Ediciones, pueden ver una entrevista al autor acà). Sin que esto sea una reseña académica, queremos hacer un breve aperitivo, casi un texto de hipotètica contratapa, e invitarlos a que lean (lo pueden descargar vìa [bajalibros](https://ar.bajalibros.com/library/publication/izquierda-y-politica), o directamente en este enlace).
