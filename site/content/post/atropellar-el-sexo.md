...
date: 2026-01-20
description: Inidicios en verso de los persistentes patrones (sociales y
  simbólicos) de la violencia sexual contra las mujeres.
categories:
  - ensayos
author:
...
callouts:
  - Para valorar el daño sexual necesitamos conocer el espacio de significados
    en el que transcurre la interacción sexual heterosexual.
  - Estos antecedentes son importantes para entender cómo se gesta la violencia,
    con qué lodos se cuecen estos barros del atropello sexual, una interacción
    que encuentra a varones y mujeres posicionados de manera desigual,
    asimétrica, patriarcal.
featured_callout: 1
---
